<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    try{
        ...
        PreparedStatement st=con.prepareStatement("INSERT INTO `info` (`name`, `gender`) VALUES (?,?)");
        for(int i=1;i<cellArrayListHolder.size();i++)
        {  
                rowarrylist=(ArrayList)cellArrayListHolder.get(i);
                st.setString(1,rowarrylist.get(1).toString());
            	st.setString(2,rowarrylist.get(2).toString());
